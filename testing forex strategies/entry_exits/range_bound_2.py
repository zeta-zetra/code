...
def main(show_plot=True):
    ...
    ohlc_daily["R1"] = ohlc_daily["PP"] + 0.382*(ohlc_daily["High"] - ohlc_daily["Low"])
    ohlc_daily["S1"] = ohlc_daily["PP"] - 0.382*(ohlc_daily["High"] - ohlc_daily["Low"])
    
    ohlc_daily["R2"] = ohlc_daily["PP"] + 0.618*(ohlc_daily["High"] - ohlc_daily["Low"])
    ohlc_daily["S2"] = ohlc_daily["PP"] - 0.618*(ohlc_daily["High"] - ohlc_daily["Low"])
