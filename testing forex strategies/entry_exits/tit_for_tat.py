...
https://www.youtube.com/watch?v=k2NbKhvdmqA&list=PL3Jd92exRxKTGkeWFT4V-z8Gu3svBJ6ap&index=19
...
def main(show_plot=True):
    ...
    ohlc_subset.loc[:,"Close_1"] = ohlc_subset.loc[:,"Close"].shift(1)


    # Signal position points (i.e. for plotting)
    buy_conditions = (ohlc_subset["Close"] <  ohlc_subset["Close_1"])

    sell_conditions = (ohlc_subset["Close"] >  ohlc_subset["Close_1"]) 
