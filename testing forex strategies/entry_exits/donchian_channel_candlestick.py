...
def main(show_plot=True):
    ...
    strategy_name = "donchian-channel-candlestick"
    ...
    buy_conditions = (ohlc["Close"] > ohlc["upper"]) & ((patterns["CDL_ENGULFING"]==100) | (patterns["CDL_HARAMI"]==100))
    sell_conditions = (ohlc["Close"] <  ohlc["lower"])  & ((patterns["CDL_ENGULFING"]==-100) | (patterns["CDL_HARAMI"]==-100))
