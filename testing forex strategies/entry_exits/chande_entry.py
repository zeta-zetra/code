...
def main(show_plot=True):
    ...
    buy_conditions   = (ohlc["Close"] < ohlc["sma_5"]) & (ohlc["l_sma_5"] > ohlc["l_sma_10"]) & (ohlc["sma_5"] < ohlc["sma_10"])
    sell_conditions  = (ohlc["Close"] > ohlc["sma_5"]) & (ohlc["l_sma_5"] < ohlc["l_sma_10"]) & (ohlc["sma_5"] > ohlc["sma_10"])
